...
Source1:          grafana-vendor-%{version}-27.tar.xz

%if %{compile_frontend} == 0
# Source2 contains the precompiled frontend
# Note: In case there were no changes to this tarball, the NVR of this tarball
# lags behind the NVR of this package.
Source2:          grafana-webpack-%{version}-27.tar.gz
%endif
...
* Wed Apr 22 2026 Sam Feifer <sfeifer@redhat.com> 10.2.6-26
- Resolves RHEL-161791: CVE-2026-27877
- Resolves RHEL-166459: CVE-2026-32282
- Resolves RHEL-167494: CVE-2026-32283
...
* Tue Nov 26 2024 Sam Feifer <sfeifer@redhat.com> - 10.2.6-13
...
* Mon Nov 25 2024 Sam Feifer <sfeifer@redhat.com> - 10.2.6-12
- Resolves RHEL-68657: Update configurations to allow loading the valkey datasource
...
* Mon Oct 28 2024 Sam Feifer <sfeifer@redhat.com> - 10.2.6-8
- Resolves RHEL-63100: CVE-2024-47875

* Tue Oct 8 2024 Sam Feifer <sfeifer@redhat.com> - 10.2.6-7
- Resolves: RHEL-57874
